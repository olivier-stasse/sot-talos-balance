...
# cm_conf.CTRL_MAX = 10000.0 # temporary hack
...
# # plug(robot.pg.waistattitude, robot.waistMix.signal("sin2"))

# #robot.waistToMatrix = PoseRollPitchYawToMatrixHomo('w2m')
# #robot.waistToMatrix.displaySignals()
# #plug(robot.pg.waistattitude, robot.waistToMatrix.sin)
...
# create_topic(robot.publisher, robot.pg, 'comref', robot = robot, data_type='vector') 
