...
RIGHT_FOOT_CONTACT_POINTS = ((RIGHT_FOOT_SIZES[0], RIGHT_FOOT_SIZES[0], RIGHT_FOOT_SIZES[1], RIGHT_FOOT_SIZES[1]),
                             (RIGHT_FOOT_SIZES[3], RIGHT_FOOT_SIZES[2], RIGHT_FOOT_SIZES[3],
                              RIGHT_FOOT_SIZES[2]), (-0.105, -0.105, -0.105, -0.105))
...
LEFT_FOOT_CONTACT_POINTS = np.matrix([[LEFT_FOOT_SIZES[0], LEFT_FOOT_SIZES[3], -0.105],
                                      ...
                                      [LEFT_FOOT_SIZES[1], LEFT_FOOT_SIZES[2],
                                       -0.105]]).T  # contact points in local reference frame
