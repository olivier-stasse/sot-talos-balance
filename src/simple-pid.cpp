...
#define OUTPUT_SIGNALS m_dx_refSOUT
      ...
      /* --- DG FACTORY ---------------------------------------------------- */
      DYNAMICGRAPH_FACTORY_ENTITY_PLUGIN(SimplePID,
                                         "SimplePID");
                      ...
                      , m_initSucceeded(false)
      {
        ...
        /* Commands. */
        addCommand("init", makeCommandVoid2(*this, &SimplePID::init, docCommandVoid2("Initialize the entity.","time step","number of elements")));
        addCommand("resetIntegralError", makeCommandVoid0(*this, &SimplePID::resetIntegralError, docCommandVoid0("Set integral error to zero.")));
      }
      ...
      void SimplePID::resetIntegralError()
      {
