...
halfSitting = [0.0, 0.0,  1.018213,  0.00  ,  0.0, 0.0, 0.1,                         #Free flyer
...
assertApprox(comDes,wp.comDes.value,6)
print("Desired CoM velocity:")
print(wp.vcomDes.value)
assertApprox(vcomDes,wp.vcomDes.value,6)
print("Desired CoM acceleration:")
print(wp.acomDes.value)
assertApprox(acomDes,wp.acomDes.value,6)
print("Desired DCM:")
print(wp.dcmDes.value)
assertApprox(dcmDes,wp.dcmDes.value,6)
print("Desired ZMP:")
print(wp.zmpDes.value)
assertApprox(zmpDes,wp.zmpDes.value,6)
